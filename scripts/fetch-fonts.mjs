// Descarga Cabinet Grotesk y Switzer desde Fontshare (gitignored). En este proyecto el destino
// es src/app/fonts/fontshare/ (FONTS_OUT en los hooks predev/prebuild de package.json).
//
...
async function main() {
  ...
  console.log(`fetch-fonts: ${missing.length} archivos descargados de Fontshare en ${path.relative(ROOT, OUT)}/`);
}
